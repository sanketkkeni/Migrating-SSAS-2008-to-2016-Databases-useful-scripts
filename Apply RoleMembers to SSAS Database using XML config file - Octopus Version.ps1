...
# Scope: ******
# Description: This PS Script is used to apply roles and member information on the SSAS Database from XML Config files. This script is part of an Octopus Step Template used while deploying SSAS Databases.
